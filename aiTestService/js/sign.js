jQuery(document).ready(function($){
  ...
  //  $form_signup.find('input[type="submit"]').on('click', function(event){
  //   event.preventDefault();
  //   $form_signup.find('input[type="email"]').toggleClass('has-error').next('input').next('span').toggleClass('is-visible');
  // });
...
jQuery.fn.putCursorAtEnd = function() {
  ...
  //open modal
  $('.accept-terms').on('click', function(event){
  ...
  document.addEventListener('scroll', onScroll, { passive: true });
   function onScroll () {
       ...
       const scroll = document.querySelector('.navbar-brand');
     if (headerheight<=scrollposition && header != null){
